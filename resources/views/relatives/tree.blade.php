...
@section('content')
  <h1 class="mt-2">Árvore Genealógica</h1>
  <a href="{{url("relatives")}}" class="btn btn-primary mt-2 mb-3">Parentes</a>

  <script src="{{ url('js/go.js') }}"></script>
  <script id="code">
    ...
    function init() {
      ...
      myDiagram.nodeTemplateMap.add("M",  // male
        $(go.Node, "Vertical",
          ...
          $(go.Panel,
            { name: "ICON"},
            $(go.Shape, "Circle",
              { width: 46, strokeWidth: 0, fill: "black", portId: "" }),
              $(go.Panel, "Spot",
                { isClipping: true,
      ...
      setupDiagram(myDiagram, {!! $genogram !!});
    }
